            ...
            $.ajax({
                ...
                complete: function(xhr, textStatus) {
                    if (textStatus === "success") {
                        ...
                        form.append($("<input/>",
                                { type: "hidden", id: "LeadCategory", name: "LeadCategory", value: "Download" }))
                            .append($("<input/>",
                                { type: "hidden", id: "LeadSource", name: "LeadSource", value: "QuickStartTutorial" }))
                            .append($("<input/>", { type: "hidden", name: "version", value: "V7" }));

                        gaEvt("Action Performed",
                            "Trial Extension",
                            "Day 14",
                            function() {
                                form.submit();
                        ...
                        alert(
                            "Unable to send request due to exception. Please contact Particular at support@particular.net");
                    }
                }
            });
        });
